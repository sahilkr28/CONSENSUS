...
export default function BullCard({ report }: BullCardProps) {
  if (!report) return null;

  return (
    <div className="rounded-lg border border-green-500/10 bg-[#111111] p-6 glow-border">
      <div className="flex items-center justify-between border-b border-[#232323] pb-4 mb-4">
        <h3 className="text-xs font-semibold uppercase tracking-wider text-green-500 flex items-center gap-1.5">
          <PlusCircle className="h-4 w-4 text-green-500" />
          Bull Case Thesis
        </h3>
        <span className="rounded bg-green-950/20 border border-green-500/20 px-2 py-0.5 text-xs font-bold font-mono text-green-400">
